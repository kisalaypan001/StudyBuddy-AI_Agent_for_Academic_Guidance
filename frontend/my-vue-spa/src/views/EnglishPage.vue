<template>
    ...
    <div class="main-container-python">
            <!-- Sidebar -->
    <div class="sidebar">
      <a href="/english" class="selected-icon"><img src="@/Images/sidebar-modules-selected.svg" alt="Modules"></a>
      <a href="/english-grades"><img src="@/Images/sidebar-grades.svg" alt="Icon 2"></a>
  </div>
      <!-- Modules -->
          ...
          <li class="module">
            ...
            <ul class="sub-modules">
              <li class="sub-module active">
                <span>1.1 Sounds and Words</span>
                <span class="tag">Video</span>
              </li>
              <li class="sub-module">
                <span>1.2 Learning Language</span>
                <span class="tag">Video</span>
              </li>
              <!-- <li class="sub-module">
              ...
              <li class="sub-module">
                <span>1.3 Speech sounds in English</span>
                <span class="tag">Video</span>
              </li>
            </ul>
          </li>
      ...
      <div class="content-python">
        <div class="video-details">
          <h1>1.1 Sounds and Words</h1>
          <p>Week 1: Topic: Introduction to English Course</p>
          <div class="rating">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube.com/embed/EPa6ATqMI9g?si=nmMIa-NqjkPI1MK4"
            title="YouTube video"
          ></iframe>
        </div>
      </div>
      ...
      <div class="right-panel">
        ...
        <div class="transcript">
          ...
          <p>
            Topic: Introduction to English Course. IIT Madras welcomes you to the
